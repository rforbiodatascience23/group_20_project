---
title: "Proteins in humans and mice"
format: 
  revealjs:
    scrollable: true
...
-   Use R and github for a collaborative life science project 

-   The mouse as a model organism 

-   Differences/similarites in protein location, role and more between mice and humans.

-   Summary statistics on clean data and more elaborate analysis on augmented data

## Materials

-   Gene oncology and amino acid seq data from swiss-prot reviewed uniprot data
