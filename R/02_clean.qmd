...
joined_data <- joined_data |>
  ...
  rename(GO_molceular_function = `gene_ontology_(molecular_function)`) |> 
  # Remove GO numbers
  mutate(GO_molceular_function = str_remove_all(GO_molceular_function, "\\[.*?\\]")) |> 
  # Use delimiter to make data longer
  separate_longer_delim(GO_molceular_function, delim = " ; ")
