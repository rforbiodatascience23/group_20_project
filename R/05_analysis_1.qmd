...
ggsave("05_analysis_mol_func.png",
       path = "../results")
```
...
ggsave("05_analysis_cofactor_size.png",
       path = "../results")
```
...
ggsave("05_analysis_lm_size_length.png",
       path = "../results")
...
ggsave("05_analysis_pH_length.png",
       path = "../results")
```
...
ggsave("05_analysis_class_size.png",
       path = "../results")
```
...
ggsave("05_analysis_location_size.png",
       path = "../results")
```
